...
<template>
  <page-container title="商品列表">
    ...
    <el-table :data="goodsList" style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="goods_stock" label="数量" width="80" align="center" />
      ...
      <el-form ref="editFormRef" :model="editForm" :rules="editRules" label-width="100px">
        ...
        <el-form-item label="新旧程度">
          <el-select v-model="editForm.goods_new_level" style="width: 240px">
            ...
            <!-- 新旧程度：1-全新，2-99新，3-95新，4-9成新，5-8成新，6-7成及以下 -->
        ...
        <el-form-item label="商品数量">
          <el-input v-model="editForm.goods_stock" type="number" />
        </el-form-item>
